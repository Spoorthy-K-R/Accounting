...
base_path = '/Users/spoorthy/Projects/Accounting/NVIDIA/output-csv-yahoo/'

balance_sheets = [base_path +"all_balance_sheets.csv"]
cash_flows = [base_path +"all_cashflow.csv"]
income_statements = [base_path +"all_income_statements.csv"]
...
# Save output
out_file = f"/Users/spoorthy/Projects/Accounting/NVIDIA/output-txt-yahoo/NVIDIA_yahoo_analysis.txt"
